...
<div class="mt-8 border border-neutral dark:border-dark-neutral-border rounded-lg overflow-hidden shadow-sm bg-neutral-bg dark:bg-dark-neutral-bg">
    ...
    <div class="p-6">
        <div class="space-y-6">
            <div>
                <label class="block text-sm font-semibold text-gray-800 dark:text-white mb-2">Focus Keyphrase</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-800 dark:text-white mb-2">SEO Title</label>
                <div class="mb-2 flex flex-wrap gap-2" id="seo-title-vars">
                    <button type="button" class="btn normal-case h-fit min-h-fit py-1 px-2 text-xs bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700 transition-colors" data-val="{title}">+ Page Title</button>
                    <button type="button" class="btn normal-case h-fit min-h-fit py-1 px-2 text-xs bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700 transition-colors" data-val="{sep}">+ Separator</button>
                    <button type="button" class="btn normal-case h-fit min-h-fit py-1 px-2 text-xs bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700 transition-colors" data-val="{sitename}">+ Site Name</button>
                    <button type="button" class="btn normal-case h-fit min-h-fit py-1 px-2 text-xs bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700 transition-colors" data-val="{tagline}">+ Tagline</button>
                </div>
                <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-800 dark:text-white mb-2">Meta Description</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-800 dark:text-white mb-2">Keywords (comma separated)</label>
                <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-800 dark:text-white mb-2">Robots</label>
