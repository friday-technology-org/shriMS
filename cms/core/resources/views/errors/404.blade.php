...
@section('title', '404 Not Found - Shri-ms')
...
@section('content')
    <div class="flex items-center text-xs gap-x-[11px] mb-[34px]">
        <div class="flex items-center gap-x-1"><img src="{{ asset('assets/images/icons/icon-home-2.svg') }}"
            ...
            class="capitalize text-color-brands">Error 404</span>
    </div>
    ...
    <div class="flex flex-col items-center justify-center min-h-[50vh] text-center bg-white dark:bg-[#313442] rounded-[16px] border border-neutral dark:border-dark-neutral-border p-10">
        <h1 class="text-[120px] font-bold text-gray-200 dark:text-gray-dark-1100 leading-none mb-4">404</h1>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">Page Not Found</h2>
        <p class="text-gray-500 dark:text-gray-dark-500 max-w-md mb-8">The page you are looking for doesn't exist, has been removed, or is temporarily unavailable.</p>
