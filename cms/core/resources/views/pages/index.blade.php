...
<div>
    ...
    <div class="flex items-center"><img src="{{ asset('assets/images/icons/icon-search-normal.svg') }}" alt="seacrh icon">
        <input class="input w-full bg-transparent outline-none h-5 text-gray-400 text-sm leading-4 focus:!outline-none placeholder:text-gray-400 dark:placeholder:text-gray-dark-400 pl-[11px]" type="text" placeholder="Search page">
    </div>
