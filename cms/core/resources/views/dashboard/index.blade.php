...
@section('content')
        ...
        <div>
          ...
          <div class="flex justify-between flex-col gap-y-2 sm:flex-row mb-[34px]">
            ...
            <div class="items-center gap-x-2 flex"><img src="{{ asset('assets/images/icons/icon-calendar-1.svg') }}" alt="calendar icon">
          ...
          <section>
              ...
              <div class="grid grid-cols-1 gap-x-[22.75px] gap-y-[24.21px] xl:grid-cols-4 lg:grid-cols-2">
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-green" src="{{ asset('assets/images/icons/icon-bag-happy.svg') }}" alt="bag happy icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">{{ number_format($postsCount) }}</span></div>
                    ...
                    <div class="dropdown dropdown-end translate-x-4 z-10 self-start">
                      <label class="cursor-pointer dropdown-label flex items-center justify-between py-2 px-4" tabindex="0"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-toggle.svg') }}" alt="toggle icon">
                      </label>
                  ...
                  <div class="flex items-center justify-between"><span class="text-gray-500 text-xs dark:text-gray-dark-500">Posts</span>
                    <div class="flex items-center gap-x-[7px]"><img src="{{ asset('assets/images/icons/icon-export-green.svg') }}" alt="export icon"><span class="text-green font-medium text-[16px] leading-[16px]">34.7%</span></div>
                  </div>
                </div>
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-blue" src="{{ asset('assets/images/icons/icon-messages-2.svg') }}" alt="messages icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">{{ number_format($pagesCount) }}</span></div>
                    <div class="translate-x-4">
                  ...
                  <div class="flex items-center justify-between"><span class="text-gray-500 text-xs dark:text-gray-dark-500">Pages</span>
                    <div class="flex items-center gap-x-[7px]"><img src="{{ asset('assets/images/icons/icon-export-green.svg') }}" alt="export icon"><span class="text-green font-medium text-[16px] leading-[16px]">18.7%</span></div>
                  </div>
                </div>
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-violet" src="{{ asset('assets/images/icons/icon-folder-2.svg') }}" alt="folder icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">{{ number_format($cptCount) }}</span></div>
                    <div class="translate-x-4">
                  ...
                  <div class="flex items-center justify-between"><span class="text-gray-500 text-xs dark:text-gray-dark-500">Custom Post Types</span>
                    <div class="flex items-center gap-x-[7px]"><img src="{{ asset('assets/images/icons/icon-export-green.svg') }}" alt="export icon"><span class="text-green font-medium text-[16px] leading-[16px]">22.7%</span></div>
                  </div>
                </div>
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-orange" src="{{ asset('assets/images/icons/icon-user-square.svg') }}" alt="user square icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">{{ number_format($usersCount) }}</span></div>
                    <div class="translate-x-4">
                  ...
                  <div class="flex items-center justify-between"><span class="text-gray-500 text-xs dark:text-gray-dark-500">Registered Users</span>
                    <div class="flex items-center gap-x-[7px]"><img src="{{ asset('assets/images/icons/icon-export-green.svg') }}" alt="export icon"><span class="text-green font-medium text-[16px] leading-[16px]">2.7%</span></div>
                  </div>
                </div>
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-fuchsia" src="{{ asset('assets/images/icons/icon-shapes.svg') }}" alt="shapes icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">77,875</span></div>
                    <div class="translate-x-4">
                  ...
                  <div class="flex items-center justify-between"><span class="text-gray-500 text-xs dark:text-gray-dark-500">Banner Clicks</span>
                    <div class="flex items-center gap-x-[7px]"><img src="{{ asset('assets/images/icons/icon-export-green.svg') }}" alt="export icon"><span class="text-green font-medium text-[16px] leading-[16px]">12.8%</span></div>
                  </div>
                </div>
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-sky" src="{{ asset('assets/images/icons/icon-share.svg') }}" alt="share icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">1,842</span></div>
                    <div class="translate-x-4">
                  ...
                  <div class="flex items-center justify-between"><span class="text-gray-500 text-xs dark:text-gray-dark-500">Social Shared</span>
                    <div class="flex items-center gap-x-[7px]"><img src="{{ asset('assets/images/icons/icon-export-green.svg') }}" alt="export icon"><span class="text-green font-medium text-[16px] leading-[16px]">3.7%</span></div>
                  </div>
                </div>
                <div class="flex flex-col gap-y-4 bg-neutral-bg border border-neutral-accent p-5 rounded-2xl dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex items-center justify-between"> 
                    <div class="flex gap-x-2 items-center"><img class="p-2 rounded-lg bg-red" src="{{ asset('assets/images/icons/icon-menu.svg') }}" alt="menu icon"><span class="text-gray-1100 font-bold dark:text-gray-dark-1100 text-[16px] leading-[16px]">857</span></div>
                    <div class="translate-x-4">
                ...
                <div class="bg-neutral-bg border border-neutral-accent p-5 rounded-[16.079px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                  <div class="flex justify-between">
                    <div class="flex items-center gap-x-[11px]"><img src="{{ asset('assets/images/icons/icon-shield-tick-circle.svg') }}" alt="shield tick icon">
              ...
              <div class="border bg-neutral-bg border-neutral dark:bg-dark-neutral-bg dark:border-dark-neutral-border rounded-lg py-5 px-[29px]">
                ...
                <div class="rounded-lg border border-neutral min-w-fit dark:border-dark-neutral-border p-[13px] lg:min-w-[498px] mb-[18px]">
                  <div class="flex items-center gap-y-4 flex-col gap-x-[27px] mb-[31px] lg:flex-row xl:gap-y-0">
                    <div class="flex items-center gap-x-[20px]"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-bold.svg') }}" alt="bold icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-italicized.svg') }}" alt="italicized icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-underlined.svg') }}" alt="underlined icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-strikethrough.svg') }}" alt="strikethrough icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-textcolor.svg') }}" alt="textcolor icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-backgroundcolor.svg') }}" alt="backgroundcolor icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-smile.svg') }}" alt="smile icon"></div>
                    <div class="flex items-center gap-x-[20px]">
                      <div class="flex items-center cursor-pointer gap-x-[1.5px]"><img src="{{ asset('assets/images/icons/icon-paragraphformat.svg') }}" alt="paragraphformat icon"><img src="{{ asset('assets/images/icons/icon-arrow-down-triangle.svg') }}" alt="arrow down triangle icon"></div>
                      <div class="flex items-center cursor-pointer gap-x-[1.5px]"><img src="{{ asset('assets/images/icons/icon-align-left.svg') }}" alt="align left icon"><img src="{{ asset('assets/images/icons/icon-arrow-down-triangle.svg') }}" alt="arrow down triangle icon"></div>
                      <div class="flex items-center cursor-pointer gap-x-[1.5px]"><img src="{{ asset('assets/images/icons/icon-ordered-list.svg') }}" alt="ordered list icon"><img src="{{ asset('assets/images/icons/icon-arrow-down-triangle.svg') }}" alt="arrow down triangle icon"></div>
                      <div class="flex items-center cursor-pointer gap-x-[1.5px]"><img src="{{ asset('assets/images/icons/icon-unordered-list.svg') }}" alt="unordered list icon"><img src="{{ asset('assets/images/icons/icon-arrow-down-triangle.svg') }}" alt="arrow down triangle icon"></div><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-indent.svg') }}" alt="indent icon"><img class="cursor-pointer opacity-40" src="{{ asset('assets/images/icons/icon-indent.svg') }}" alt="outdent icon">
                    </div>
                  </div>
            ...
            <div class="border bg-neutral-bg border-neutral dark:bg-dark-neutral-bg dark:border-dark-neutral-border rounded-lg pb-11 mb-6 pt-[23px] pl-[29px] pr-[22px]">
              ...
              <div class="grid grid-cols-1 gap-x-6 gap-y-[26px] sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-1.png') }}" alt="background">
                  ...
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-2.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  ...
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-3.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  ...
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-4.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  <h2 class="font-semibold text-gray-1100 text-[12px] leading-[18px] dark:text-gray-dark-1100 mb-[27px]">How to write content about your photographs</h2>
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-5.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  <h2 class="font-semibold text-gray-1100 text-[12px] leading-[18px] dark:text-gray-dark-1100 mb-[27px]">Starting your traveling blog with Vasco</h2>
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-6.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  <h2 class="font-semibold text-gray-1100 text-[12px] leading-[18px] dark:text-gray-dark-1100 mb-[27px]">How to choose the right customer for your photo business?</h2>
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-7.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  <h2 class="font-semibold text-gray-1100 text-[12px] leading-[18px] dark:text-gray-dark-1100 mb-[27px]">How to write content about your photographs</h2>
                  <button class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent"><img src="{{ asset('assets/images/icons/icon-edit-2.svg') }}" alt="edit icon"><span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">View now</span></div>
                  </button></a><a class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border" href="#"><img class="mb-[13px]" src="{{ asset('assets/images/crm-bg-8.png') }}" alt="background">
                  <div class="flex justify-between mb-[9px]"><span class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">Courtney Henry</span>
                    <time class="leading-4 text-gray-500 text-[10.5958px] dark:text-gray-dark-500">06 September</time>
                  </div>
                  <h2 class="font-semibold text-gray-1100 text-[12px] leading-[18px] dark:text-gray-dark-1100 mb-[27px]">How to write content about your photographs</h2>
                ...
                <div class="flex flex-col gap-y-[22px] xl:min-w-[361px]">
                  <div class="flex justify-between">
                    <div class="flex gap-x-3">
                      <div class="overflow-hidden w-[40px] h-[40px] rounded-[100px]"><img class="w-full h-full object-cover" src="{{ asset('assets/images/crm-avatar-7.png') }}" alt="avatar"></div>
                  ...
                  <div class="flex justify-between">
                    <div class="flex gap-x-3">
                      <div class="overflow-hidden w-[40px] h-[40px] rounded-[100px]"><img class="w-full h-full object-cover" src="{{ asset('assets/images/crm-avatar-8.png') }}" alt="avatar"></div>
                      <div class="flex flex-col gap-y-[7px]">
                  ...
                  <div class="flex justify-between">
                    <div class="flex gap-x-3">
                      <div class="overflow-hidden w-[40px] h-[40px] rounded-[100px]"><img class="w-full h-full object-cover" src="{{ asset('assets/images/crm-avatar-9.png') }}" alt="avatar"></div>
                      <div class="flex flex-col gap-y-[7px]">
          ...
          <div class="modal">
            <div class="modal-box relative bg-neutral-bg scrollbar-hide dark:bg-dark-neutral-bg">
              <label class="absolute right-2 top-2 cursor-pointer" for="details-modal"><img src="{{ asset('assets/images/icons/icon-close-modal.svg') }}" alt="close modal button"></label>
              ...
              <div class="flex items-end justify-between mb-[76px]">
                <div class="flex items-start gap-x-[10px]">
                  <div class="w-12 h-12 flex items-center justify-center rounded-full bg-[#E8EDF2] dark:bg-[#313442]"><img class="dark:invert" src="{{ asset('assets/images/icons/icon-user.svg') }}" alt="user icon"></div>
              ...
              <div class="flex items-end justify-between mb-2">
                <div class="flex items-start gap-x-[10px]">
                  <div class="w-12 h-12 flex items-center justify-center rounded-full bg-[#E8EDF2] dark:bg-[#313442]"><img class="dark:invert" src="{{ asset('assets/images/icons/icon-home-hashtag.svg') }}" alt="home icon"></div>
                  <div class="flex flex-col gap-y-2">
              ...
              <div class="flex items-center justify-between flex-wrap gap-3">
                <div class="flex items-center gap-[15px]">
                  <button class="border-0 capitalize font-semibold py-4 px-8 text-gray-500 bg-neutral flex items-center gap-2 text-[12px] leading-[21px] dark:text-gray-dark-500 dark:bg-dark-neutral-border hover:opacity-80 rounded-[10px]"> 
                    <p>Print</p><i> <img src="{{ asset('assets/images/icons/icon-printer.svg') }}" alt="print icon"></i>
                  </button>
                  <button class="bg-transparent font-semibold flex items-center text-[12px] leading-[21px] dark:text-gray-dark-500 hover:opacity-80 rounded-[10px] gap-[10px]"> 
                    <p>Download Pdf</p><i> <img src="{{ asset('assets/images/icons/icon-down.svg') }}" alt="down icon"></i>
                  </button>
                </div>
                <button class="border-0 capitalize font-semibold py-4 px-8 text-gray-500 bg-neutral flex items-center gap-2 text-[12px] leading-[21px] dark:text-gray-dark-500 dark:bg-dark-neutral-border hover:opacity-80 rounded-[10px]"> 
                  <p>Issue Refund</p><i> <img src="{{ asset('assets/images/icons/icon-refunds.svg') }}" alt="print icon"></i>
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="modal">
            <div class="modal-box relative bg-neutral-bg scrollbar-hide dark:bg-dark-neutral-bg pt-[53px]">
              <label class="absolute right-2 top-2 cursor-pointer" for="project-modal"><img src="{{ asset('assets/images/icons/icon-close-modal.svg') }}" alt="close modal button"></label>
              <div class="flex items-center justify-center flex-col">
                ...
                <div class="cursor-pointer show-add-project-2"><img class="hover:opacity-80 mb-[29px] dark:hidden" src="{{ asset('assets/images/icons/add-project.svg') }}" width="92" height="92" alt="add project icon"><img class="hidden hover:opacity-80 mb-[29px] dark:block" src="{{ asset('assets/images/icons/add-project-dark.svg') }}" width="92" height="92" alt="add project icon"></div>
          ...
          <div class="modal">
            <div class="modal-box relative bg-neutral-bg scrollbar-hide w-full dark:bg-dark-neutral-bg pt-[53px] max-w-[794px]">
              <label class="absolute right-2 top-2 cursor-pointer" for="add-modal"><img src="{{ asset('assets/images/icons/icon-close-modal.svg') }}" alt="close modal button"></label>
              <div class="flex items-center justify-center flex-col">
                ...
                <div class="w-full flex flex-col max-w-[531px] gap-[30px] mb-[60px] lg:mb-[166px]">
                  <div class="border-dashed border-2 text-center border-neutral mx-auto cursor-pointer py-[26px] dark:border-dark-neutral-border w-full max-w-[724px]"><img class="mx-auto inline-block mb-[15px]" src="{{ asset('assets/images/icons/icon-image.svg') }}" alt="image icon">
                  ...
                  <div class="w-full">
                    ...
                    <div class="rounded-lg border border-neutral flex flex-col dark:border-dark-neutral-border p-[13px] h-[218px]">
                      <div class="flex items-center gap-y-4 flex-col gap-x-[22px] mb-[31px] xl:flex-row xl:gap-y-0">
                        <div class="flex items-center gap-x-[14px]"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-bold.svg') }}" alt="bold icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-italicized.svg') }}" alt="italicized icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-underlined.svg') }}" alt="underlined icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-strikethrough.svg') }}" alt="strikethrough icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-textcolor.svg') }}" alt="textcolor icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-backgroundcolor.svg') }}" alt="backgroundcolor icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-smile.svg') }}" alt="smile icon"></div>
                        ...
                        <div class="flex items-center gap-x-[14px]"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-insert-image.svg') }}" alt="insert image icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-insert-link.svg') }}" alt="insert link icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-insert-file.svg') }}" alt="insert-file icon"><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-insert-video.svg') }}" alt="insert video icon"><img class="cursor-pointer opacity-40" src="{{ asset('assets/images/icons/icon-undo.svg') }}" alt="undo icon"><img class="cursor-pointer opacity-40" src="{{ asset('assets/images/icons/icon-redo.svg') }}" alt="redo icon"></div>
                      </div>
                  ...
                  <div class="w-full"> 
                    ...
                    <div class="border bg-neutral-bg border-neutral dark:bg-dark-neutral-bg dark:border-dark-neutral-border rounded-lg p-[15px] mt-[10px] min-h-[107px]">
                      <div class="flex flex-wrap gap-[10px]">
                        <div class="flex items-center py-1 px-2 gap-x-[5px] mb-[10px] bg-[#E8EDF2] dark:bg-[#313442] rounded-[5px]"><span class="text-xs text-gray-400">smartwatch</span><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-close.svg') }}" alt="close icon"></div>
                        <div class="flex items-center py-1 px-2 gap-x-[5px] mb-[10px] bg-[#E8EDF2] dark:bg-[#313442] rounded-[5px]"><span class="text-xs text-gray-400">Apple</span><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-close.svg') }}" alt="close icon"></div>
                        <div class="flex items-center py-1 px-2 gap-x-[5px] mb-[10px] bg-[#E8EDF2] dark:bg-[#313442] rounded-[5px]"><span class="text-xs text-gray-400">Watch</span><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-close.svg') }}" alt="close icon"></div>
                        <div class="flex items-center py-1 px-2 gap-x-[5px] mb-[10px] bg-[#E8EDF2] dark:bg-[#313442] rounded-[5px]"><span class="text-xs text-gray-400">smartphone</span><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-close.svg') }}" alt="close icon"></div>
                        <div class="flex items-center py-1 px-2 gap-x-[5px] mb-[10px] bg-[#E8EDF2] dark:bg-[#313442] rounded-[5px]"><span class="text-xs text-gray-400">iPhone14 max</span><img class="cursor-pointer" src="{{ asset('assets/images/icons/icon-close.svg') }}" alt="close icon"></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="modal">
            <div class="modal-box relative bg-neutral-bg scrollbar-hide w-full dark:bg-dark-neutral-bg pt-[53px] max-w-[738px] pr-[31px]">
              <label class="absolute right-2 top-2 cursor-pointer" for="share-modal"><img src="{{ asset('assets/images/icons/icon-close-modal.svg') }}" alt="close modal button"></label>
              <div class="flex items-center justify-center flex-col">
                ...
                <div class="w-full mb-[65px]"> 
                  ...
                  <div class="flex items-center justify-between rounded-md bg-neutral py-[11px] px-[10px] dark:bg-dark-neutral-border">
                    ...
                    <div class="flex items-center text-blue gap-[6px]"><img src="{{ asset('assets/images/icons/Icon-link.svg') }}" alt="link icon">
                ...
                <div class="w-full flex items-center justify-between mb-[30px]">
                  <div class="flex items-center gap-3"> <a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="{{ asset('assets/images/avatar-layouts-1.png') }}" alt="user avatar"></a>
                ...
                <div class="w-full mb-[42px]">
                  ...
                  <div class="flex flex-col items-center gap-6 w-full">
                    <div class="flex items-center justify-between w-full">
                      <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="{{ asset('assets/images/avatar-layouts-2.png') }}" alt="user avatar"></a>
                        <div>
                    ...
                    <div class="flex items-center justify-between w-full">
                      <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="{{ asset('assets/images/avatar-layouts-3.png') }}" alt="user avatar"></a>
                        <div>
                    ...
                    <div class="flex items-center justify-between w-full">
                      <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="{{ asset('assets/images/avatar-layouts-4.png') }}" alt="user avatar"></a>
                        <div>
                    ...
                    <div class="flex items-center justify-between w-full">
                      <div class="flex items-center gap-3"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 border-none" href="seller-details.html"><img class="w-full h-full object-cover" src="{{ asset('assets/images/avatar-layouts-5.png') }}" alt="user avatar"></a>
                        <div>
          ...
          <div class="modal">
            <div class="modal-box relative bg-neutral-bg scrollbar-hide w-full dark:bg-dark-neutral-bg pt-[38px] max-w-[650px] pl-[45px]">
              <label class="absolute right-2 top-2 cursor-pointer" for="mail-modal"><img src="{{ asset('assets/images/icons/icon-close-modal.svg') }}" alt="close modal button"></label>
              <div class="flex items-center justify-center flex-col">
                  ...
                  <div class="flex items-center rounded-lg border border-neutral justify-between w-full flex-wrap gap-3 py-[13px] px-[10px] dark:border-dark-neutral-border">
                    <div class="flex items-center">
                      ...
                      <div class="flex items-center flex-wrap gap-[5px]">
                        <div class="flex items-center rounded gap-[5px] py-[6px] pl-[10px] pr-[5px] bg-neutral dark:bg-dark-neutral-border"><img class="rounded-full w-4 h-4" src="{{ asset('assets/images/seller-avatar-2.png') }}" alt="user avatar">
                        ...
                        <div class="flex items-center rounded gap-[5px] py-[6px] pl-[10px] pr-[5px] bg-neutral dark:bg-dark-neutral-border"><img class="rounded-full w-4 h-4" src="{{ asset('assets/images/seller-avatar-3.png') }}" alt="user avatar">
                          <p class="font-medium text-gray-400 text-[10px] leading-[15px] dark:text-gray-dark-400">Hailen</p>
                          <svg class="fill-gray-400 cursor-pointer dark:fill-gray-dark-400" width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.20003 8.00001L4.80003 10.4L5.60003 11.2L8.00002 8.80001L10.4 11.2L11.2 10.4L8.80002 8.00001L11.2 5.60001L10.4 4.80001L8.00002 7.20001L5.6 4.79999L4.8 5.59999L7.20003 8.00001Z"></path>
                          </svg>
                        </div>
                        <div class="flex items-center rounded gap-[5px] py-[6px] pl-[10px] pr-[5px] bg-neutral dark:bg-dark-neutral-border"><img class="rounded-full w-4 h-4" src="{{ asset('assets/images/seller-avatar-4.png') }}" alt="user avatar">
