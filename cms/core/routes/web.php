...
Route::middleware(['web'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            // Using generic 'content' parameter to avoid conflicts, first param is postTypeSlug
            ...
            Route::post('appearance/themes/{theme}/activate', [\Cms\Core\Http\Controllers\ThemeController::class, 'activate'])->name('cms.themes.activate');
            Route::delete('appearance/themes/{theme}', [\Cms\Core\Http\Controllers\ThemeController::class, 'destroy'])->name('cms.themes.destroy');
            Route::get('appearance/themes/{theme}/preview', [\Cms\Core\Http\Controllers\ThemeController::class, 'preview'])->name('cms.themes.preview');
            ...
            // 4. API tokens
            Route::get('settings/api-tokens', [\Cms\Core\Http\Controllers\ApiController::class, 'getTokens'])->name('cms.api-tokens.index');
            Route::post('settings/api-tokens', [\Cms\Core\Http\Controllers\ApiController::class, 'generateToken'])->name('cms.api-tokens.store');
            Route::delete('settings/api-tokens/{id}', [\Cms\Core\Http\Controllers\ApiController::class, 'revokeToken'])->name('cms.api-tokens.destroy');
