...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box float-bob-y clearfix">
                        <figure class="image image-1 wow fadeInUp" data-wow-delay="900ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/phone-1.png") }}" alt=""></figure>
                        <figure class="image image-2 wow fadeInUp" data-wow-delay="1500ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/phone-2.png") }}" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 image-column">
                    <div id="iamge_block_01">
                        <div class="image-box float-bob-y">
                            <figure class="image wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/phone-3.png") }}" alt=""></figure>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                        <div class="single-item">
                                            <div class="bg-layer" style="background-image: url({{ theme_asset("assets/images/resource/case-1.png") }});"></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow flipInY animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box js-tilt">
                            ...
                            <div class="icon-box">
                                <div class="bg-layer" style="background-image: url({{ theme_asset("assets/images/icons/feature-icon-1.png") }});"></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow flipInY animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box js-tilt">
                            <div class="hover-content"></div>
                            <div class="icon-box">
                                <div class="bg-layer" style="background-image: url({{ theme_asset("assets/images/icons/feature-icon-2.png") }});"></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow flipInY animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box js-tilt">
                            <div class="hover-content"></div>
                            <div class="icon-box">
                                <div class="bg-layer" style="background-image: url({{ theme_asset("assets/images/icons/feature-icon-3.png") }});"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div id="iamge_block_02">
                                <div class="image-box">
                                    <div class="bg-layer" style="background-image: url({{ theme_asset("assets/images/icons/image-shap-1.png") }});"></div>
                                    <figure class="image image-1 wow slideInRight" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/dashbord-1.jpg") }}" alt=""></figure>
                                    <figure class="image image-2 wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/dashbord-2.jpg") }}" alt=""></figure>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div id="iamge_block_03">
                                <div class="image-box">
                                    <div class="bg-layer" style="background-image: url({{ theme_asset("assets/images/icons/image-shap-2.png") }});"></div>
                                    <figure class="image image-1 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/dashbord-3.jpg") }}" alt=""></figure>
                                    <figure class="image image-2 wow slideInLeft" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/dashbord-4.jpg") }}" alt=""></figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
    ...
    <section class="video-section">
        <div class="bg-column" style="background-image: url({{ theme_asset("assets/images/background/video-bg.jpg") }});"></div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="tab active-tab" id="tab-1">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12 pricing-column">
                                <div class="pricing-block-one">
                                    <div class="pricing-table">
                                        <figure class="image"><img src="{{ theme_asset("assets/images/icons/price-icon-1.png") }}" alt=""></figure>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 pricing-column">
                                <div class="pricing-block-one">
                                    <div class="pricing-table">
                                        <figure class="image"><img src="{{ theme_asset("assets/images/icons/price-icon-2.png") }}" alt=""></figure>
                                        <div class="table-header">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 pricing-column">
                                <div class="pricing-block-one">
                                    <div class="pricing-table">
                                        <figure class="image"><img src="{{ theme_asset("assets/images/icons/price-icon-3.png") }}" alt=""></figure>
                                        <div class="table-header">
    ...
    <section class="testimonial-section centred">
        <div class="image-layer" style="background-image: url({{ theme_asset("assets/images/icons/testimonial-bg.png") }});"></div>
        <div class="container">
            <div class="sec-title center">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 testimonial-block">
                            <div class="testimonial-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="{{ theme_asset("assets/images/resource/testimonial-1.png") }}" alt=""></figure>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 testimonial-block">
                            <div class="testimonial-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="{{ theme_asset("assets/images/resource/testimonial-2.png") }}" alt=""></figure>
                                    <div class="text">“We don't take ourselves too seriously, but seriously enough to ensure we're creating the best product and experience for our customers. I feel like Help Scout does the same.”</div>  
                                    <div class="author-info">
    ...
    <section class="download-section">
        <div class="bg-layer wow slideInLeft animated" style="background-image: url({{ theme_asset("assets/images/icons/shap-3.png") }});"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="iamge_block_04">
                        <div class="image-box">
                            <figure class="image image-1 wow slideInUp" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/phone-4.png") }}" alt=""></figure>
                            <figure class="image image-2 wow slideInUp" data-wow-delay="600ms" data-wow-duration="1500ms"><img src="{{ theme_asset("assets/images/resource/phone-5.png") }}" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 news-column">
                    <div class="news-block-one wow flipInY animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-single.html"><img src="{{ theme_asset("assets/images/resource/news-1.jpg") }}" alt=""></a></figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-column">
                    <div class="news-block-one wow flipInY animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-single.html"><img src="{{ theme_asset("assets/images/resource/news-2.jpg") }}" alt=""></a></figure>
                            <div class="lower-content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-column">
                    <div class="news-block-one wow flipInY animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-single.html"><img src="{{ theme_asset("assets/images/resource/news-3.jpg") }}" alt=""></a></figure>
                            <div class="lower-content">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="iamge_block_05">
                        <div class="image-box wow slideInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <figure class="image float-bob-y"><img src="{{ theme_asset("assets/images/resource/subscribe-1.png") }}" alt=""></figure>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
