...
<!-- Fav Icon -->
<link rel="icon" href="{{ theme_asset('assets/images/favicon.ico') }}" type="image/x-icon">
            ...
            <div class="container">
                <div class="main-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><a href="index.html"><img src="{{ theme_asset('assets/images/logo.png') }}" alt=""></a></figure>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                            <div class="about-widget footer-widget">
                                <figure class="footer-logo"><a href="index.html"><img src="{{ theme_asset('assets/images/footer-logo.png') }}" alt=""></a></figure>
